        ...
        <div id="resultat" class="row">
            ...
            <form name="inscription" method="post">
                <div class="form-group">
                    <input type="text" placeholder="Saisissez votre nom" name="nom" class="form-control"></input><br />
                    <input type="text" placeholder="Saisissez votre prenom" name="prenom" class="form-control"></input><br />
                    <input type="number" placeholder="Saisissez votre age" name="age" class="form-control"></input><br />
                    <button class="btn btn-primary" type="submit" name="valider" value="OK">Soumettre</button>
                </div>
            </form>
            </div>
            <div class="col-6 d-flex align-items-center justify-content-center">
                ...
                if(isset($_POST['valider'])){
                    ...
                    $prenom=$_POST['prenom'];
                    $age=$_POST['age'];
                    echo '<div class="alert-success p-3">Vous vous appelez '.$prenom.' '.$nom.' et vous avez '.$age. ' ans.</div>';
                }
                ?>
